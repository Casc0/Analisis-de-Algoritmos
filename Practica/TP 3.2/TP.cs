...
// Command-line arguments: run --no-verify /home/casc0/Mis-Cosas/Fai/Estudiante/Carreras/Tercer Año/Analisis-de-Algoritmos/Practica/TP 3.2/TP.dfy
// TP.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      BigInteger _out0;
      _out0 = __default.sumaSecuencia(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(-42), new BigInteger(3), new BigInteger(4), new BigInteger(5)));
