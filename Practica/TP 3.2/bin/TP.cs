// Dafny program TP.dfy compiled into C#
...
// Command-line arguments: build --output bin/TP /home/casc0/Mis-Cosas/Fai/Estudiante/Carreras/Tercer Año/Analisis-de-Algoritmos/Practica/TP 3.2/TP.dfy
// TP.dfy

method Main(_noArgsParameter: seq<seq<char>>)
{
  var resultadoFinal := sumaSecuencia([1, 2, 3, 4, 5]);
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      BigInteger _0_resultadoFinal;
      BigInteger _out0;
      _out0 = __default.sumaSecuencia(Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(2), new BigInteger(3), new BigInteger(4), new BigInteger(5)));
      _0_resultadoFinal = _out0;
      Dafny.Helpers.Print((_0_resultadoFinal));
    }
    public static BigInteger Triple(BigInteger x)
    {
      ...
      if ((x).Sign != -1) {
        BigInteger _0_y;
        BigInteger _out0;
        _out0 = __default.Doble(x);
        _0_y = _out0;
        r = (x) + (_0_y);
      } else {
        BigInteger _1_y;
        BigInteger _out1;
        _out1 = __default.Doble((BigInteger.Zero) - (x));
        _1_y = _out1;
        r = (x) + (_1_y);
      }
      return r;
    }
    public static BigInteger Doble(BigInteger x)
    {
      BigInteger r = BigInteger.Zero;
      r = (x) + (x);
      return r;
    }
    public static void sumMax(BigInteger x, BigInteger y, out BigInteger s, out BigInteger m)
    {
      s = BigInteger.Zero;
      m = BigInteger.Zero;
      s = (x) + (y);
    ...
    public static BigInteger sumaSecuencia(Dafny.ISequence<BigInteger> secuencia)
    {
      BigInteger suma = BigInteger.Zero;
      suma = __default.sumar(secuencia);
      return suma;
    }
    public static BigInteger sumar(Dafny.ISequence<BigInteger> sec) {
      BigInteger _0___accumulator = BigInteger.Zero;
    TAIL_CALL_START: ;
      if ((new BigInteger((sec).Count)).Sign == 0) {
        return (BigInteger.Zero) + (_0___accumulator);
      } else {
        _0___accumulator = (_0___accumulator) + ((sec).Select(BigInteger.Zero));
        Dafny.ISequence<BigInteger> _in0 = (sec).Drop(BigInteger.One);
        sec = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static bool EsCapicua(BigInteger[] arr)
    {
      bool capicua = false;
      BigInteger _0_cont;
      _0_cont = BigInteger.Zero;
      BigInteger _1_longi;
      _1_longi = new BigInteger((arr).Length);
      capicua = true;
      while (((_0_cont) < (Dafny.Helpers.EuclideanDivision(_1_longi, new BigInteger(2)))) && (capicua)) {
        capicua = ((arr)[(int)(_0_cont)]) == ((arr)[(int)(((_1_longi) - (BigInteger.One)) - (_0_cont))]);
        _0_cont = (_0_cont) + (BigInteger.One);
      }
      return capicua;
    }
  }
